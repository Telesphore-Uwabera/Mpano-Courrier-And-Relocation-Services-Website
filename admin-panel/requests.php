...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        <div class="d-flex align-items-center justify-content-between">
            <a href="dashboard.php" class="logo d-flex align-items-center">
                <span class="d-none d-lg-block">Welcome To MCRS</span>
            </a>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- Display the table of enquiries -->
                        ...
                        <tbody>
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo '<td>' . htmlspecialchars($row['moving_from']) . '</td>';
                                    echo '<td>' . htmlspecialchars($row['moving_to']) . '</td>';
                                    echo '<td>' . htmlspecialchars($row['message']) . '</td>';
                                    echo '<td>' . htmlspecialchars($row['created_at']) . '</td>';
                                    echo '<td><a href="requests.php?delete_id=' . $row['id'] . '"><span class="badge bg-danger">Delete</span></a></td>';
                                    echo '</tr>';
                                    $count++;
                                }
                            } else {
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
        ©2024 MCRS, All rights reserved.</a>.
        </div>
    </footer>
    <!-- End Footer -->
